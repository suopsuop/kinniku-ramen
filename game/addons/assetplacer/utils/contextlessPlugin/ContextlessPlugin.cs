...
public abstract partial class ContextlessPlugin : EditorPlugin
{
	...
	{
		if (!Engine.IsEditorHint()) return;
		if (_drawPanel != null && IsInstanceValid(_drawPanel))
		{
			_drawPanel.QueueFree();
		}
